    ...
    songs: [
      {
        ...
        title: "Damage",
        duration: "2:23",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/01. Damage.wav`,
      },
      {
        id: "19-02",
        title: "Entre Cornisas y Áticos",
        duration: "3:38",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/02. Entre Cornisas y Áticos.wav`,
      },
      {
        id: "19-03",
        title: "Me Nombra",
        duration: "3:44",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/03. Me Nombra.wav`,
      },
      {
        id: "19-04",
        title: "El Juego del Ego",
        duration: "2:50",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/04. El Juego del Ego.wav`,
      },
      {
        id: "19-05",
        title: "Golden Boy",
        duration: "3:17",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/05. Golden Boy.wav`,
      },
      {
        id: "19-06",
        title: "Abstracto",
        duration: "3:30",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/06. Abstracto.wav`,
      },
      {
        id: "19-07",
        title: "Me Tengo Miedo (Con Soriano)",
        duration: "4:08",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/07. Me Tengo Miedo (Con Soriano).wav`,
      },
      {
        id: "19-08",
        title: "Tallando el Aire",
        duration: "4:11",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/08. Tallando el Aire.wav`,
      },
      {
        id: "19-09",
        title: "Infusión y Valeriana",
        duration: "4:46",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/09. Infusión y Valeriana.wav`,
      },
      {
        id: "19-10",
        title: "Taima (Con Flameh y BubenKing)",
        duration: "3:19",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/10. Taima (Con Flameh y BubenKing).wav`,
      },
      {
        id: "19-11",
        title: "John Doe",
        duration: "4:07",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/11. John Doe.wav`,
      },
      {
        id: "19-12",
        title: "Cuando el Mármol se Convierte en Agua (Con Kattman)",
        duration: "4:02",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/12. Cuando el Marmol se Convierte en Agua (Con Kattman).wav`,
      },
      {
        id: "19-13",
        title: "El Bosque (Con Blanka Bernal)",
        duration: "3:20",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/13. El Bosque (Con Blanka Bernal).wav`,
      },
      {
        id: "19-14",
        title: "Manos a la Obra de Arte",
        duration: "4:32",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/14. Manos a la Obra de Arte.wav`,
      },
      {
        id: "19-15",
        title: "Entelequia",
        duration: "3:50",
        fileUrl: `${BASE_URL}/19. Camel No Sabaku & DJ Juanpe - Manos a la Obra de Arte (2025)/15. Entelequia.wav`,
      },
    ],
  },
  {
