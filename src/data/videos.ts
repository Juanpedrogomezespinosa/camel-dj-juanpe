...
// CORRECCIÓN: Dejamos esto vacío porque los vídeos están en la raíz
const VIDEO_PATH = "";
// Las portadas SÍ están en una carpeta, así que esto se queda así
...
export const videos: Video[] = [
  {
    ...
    duration: "3:50",
    // Fíjate que ahora la ruta será BASE_URL + /nombre.mp4
  ...
  },
  {
    ...
    description:
      "Tercer y último videoclip adelanto del próximo trabajo 'Manos a la Obra de Arte'. Scratches y producción por DJ Juanpe.",
  ...
  },
  {
    ...
    director: "Nowker Films",
    description:
      "Segundo Videoclip adelanto de 'Manos a la Obra de Arte'. Instrumental por DJ Juanpe y grabado en Paco Studios.",
  ...
  },
  {
    ...
    director: "Eris Films",
    description:
      "Primer adelanto del próximo disco MANOS A LA OBRA DE ARTE. Producido por DJ Juanpe, grabado en Area90 y mezclado por Jorge Gascón.",
  ...
  },
  {
    ...
    director: "Nowker Films",
    description:
      "Extraído del trabajo 'Quimeras & Utopias'. Grabado entre Sevilla y Murcia (Killuminati Studios).",
  ...
  },
  {
    ...
    description:
      "Los Interrogatorios, con Juan Profundo (Barcelona) y Camel (Cádiz) en 'Visto lo Visto'.",
  ...
  },
  {
    ...
    description:
      "Segundo adelanto de 'RAKUDA'. Grabado en San Roque. Prod. DJ Juanpe, mezcla por Jorge Gascón.",
  ...
  },
  {
    ...
    description:
      "Primer videoclip del MC gaditano Camel, presentación de su trabajo 'Rakuda'. Con la colaboración de Kako M.",
    tags: ["Rakuda", "Debut"],
    duration: "3:15",
  ...
  },
  {
    ...
    description:
      "Videoclip oficial extraído de la maqueta de Gigante 'Metamorfosis'. Prod por eZClick. Scratches por Dj Juanpe & Dj Borke. Colaboración masiva de la escena local.",
